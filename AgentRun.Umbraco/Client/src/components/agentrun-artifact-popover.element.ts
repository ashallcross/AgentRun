...
import "./agentrun-markdown-renderer.element.js";

@customElement("agentrun-artifact-popover")
export class AgentRunArtifactPopoverElement extends UmbLitElement {
...
declare global {
  interface HTMLElementTagNameMap {
    "agentrun-artifact-popover": AgentRunArtifactPopoverElement;
  }
}
