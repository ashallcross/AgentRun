...
describe("shallai-artifact-popover", () => {
  ...
  // 7.4: renders markdown content via shallai-markdown-renderer when loaded
  it("content is passed to markdown renderer when available", () => {
    const content = "# Scan Results\n\nAll checks passed.";
    // The component passes _content to <shallai-markdown-renderer .content=${_content}>
