...
@customElement("shallai-markdown-renderer")
export class ShallaiMarkdownRendererElement extends UmbLitElement {
...
declare global {
  interface HTMLElementTagNameMap {
    "shallai-markdown-renderer": ShallaiMarkdownRendererElement;
  }
}
