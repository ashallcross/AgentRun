...
import { g as k, a as g, c as y } from "./api-client-NjdX6lGK.js";
import { e as C, n as $, b as S, a as x, i as A, s as I, d as T, r as L } from "./instance-list-helpers-Cp7Qb08Y.js";
...
let i = class extends w {
  ...
  _navigateToInstance(t) {
    window.history.pushState({}, "", S(t, window.location.pathname));
  }
  _navigateBack() {
    window.history.pushState({}, "", x(window.location.pathname));
  }
  async _createNewRun() {
    if (!this._creating) {
      this._creating = !0;
...
//# sourceMappingURL=shallai-instance-list.element-CqGjrCWi.js.map
